    ...
    <>
      ...
      <div className="relative flex items-center group">
        ...
        <div id={"slider"} className="w-full h-full overflow-x-scroll whitespace-nowrap scroll-smooth scrollbar-hide relative">
          {movies.map((item, id) => (
            <div key={id} className="w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block relative p-2">
              ...
              <div className="absolute top-0 left-0 w-full h-full hover:bg-black/80 opacity-0 text-white hover:opacity-100">
                ...
                <p onClick={() => deleteShow(item.id)} className="absolute text-gray-300 top-4 right-4 hover:cursor-pointer">
                  <AiOutlineClose />
                </p>
              </div>
            </div>
