  ...
  return (
    <div className="w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block relative p-2">
      ...
      <div className="absolute top-0 left-0 w-full h-full hover:bg-black/80 opacity-0 text-white hover:opacity-100">
        ...
        <p onClick={saveShow}>{like ? <FaHeart className="absolute top-4 left-4 text-gray-300 hover:cursor-pointer" /> : <FaRegHeart className="absolute top-4 left-4 text-gray-300 hover:cursor-pointer" />}</p>
      </div>
    </div>
  );
};
